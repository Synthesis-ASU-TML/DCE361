...
,
					"style" : "",
					"text" : "pattr dim @initial 192 108",
					"varname" : "dim"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 659.5, 122.5, 150.0, 33.0 ],
					"style" : "",
					"text" : "Type a number here to recall a preset (if it exists)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 606.0, 128.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 711.0, 170.0, 154.0, 47.0 ],
					"style" : "",
					"text" : "Hold shift and click on any of the boxes to create a new preset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 11.0, 175.0, 262.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ 1.0 ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr rate @initial 1. @bindto movie-player::rate",
					"varname" : "rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.0, 143.0, 51.0, 22.0 ],
					"style" : "",
					"text" : "read $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 313.0, 96.0, 150.0, 60.0 ],
					"style" : "",
					"text" : "Check my inspector. Pattr should be set to store the symbol of the selected item"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 232.0, 68.0, 192.0, 22.0 ],
					"saved_object_attributes" : 					{
						"initial" : [ "chickens.mp4" ],
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "pattr vid-file @initial chickens.mp4",
					"varname" : "vid-file"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 179.0, 27.0, 22.0 ],
									"style" : "",
									"text" : "iter"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 124.0, 203.0, 22.0 ],
									"style" : "",
									"text" : "chickens.mp4 bball.mov dishes.mov"
								}
...
,
					"patching_rect" : [ 156.0, 68.0, 69.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 156.0, 110.0, 155.0, 22.0 ],
					"pattrmode" : 1,
					"style" : "",
					"varname" : "umenu"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 606.0, 170.0, 100.0, 40.0 ],
					"pattrstorage" : "storage_example",
					"style" : ""
				}
...
,
					"style" : "",
					"text" : "pattrstorage storage_example",
					"varname" : "storage_example"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "" ],
					"patching_rect" : [ 606.0, 72.0, 95.0, 22.0 ],
					"style" : "",
					"text" : "jit.world storage"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.0, 42.0, 150.0, 22.0 ],
					"style" : ""
				}
