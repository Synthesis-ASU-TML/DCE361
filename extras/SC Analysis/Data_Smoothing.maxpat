...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1133.0, 252.0, 213.0, 22.0 ],
					"style" : "",
					"text" : "sc.util.downsample @block_size 1000",
					"varname" : "sc.util.downsample[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1133.0, 228.0, 207.0, 22.0 ],
					"style" : "",
					"text" : "sc.util.downsample @block_size 500",
					"varname" : "sc.util.downsample[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1133.0, 204.0, 207.0, 22.0 ],
					"style" : "",
					"text" : "sc.util.downsample @block_size 100",
					"varname" : "sc.util.downsample[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1133.0, 180.0, 200.0, 22.0 ],
					"style" : "",
					"text" : "sc.util.downsample @block_size 10",
					"varname" : "sc.util.downsample"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 58.0, 214.0, 150.0, 33.0 ],
					"style" : "",
					"text" : "Use this if no band is available"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 660.0, 272.0, 195.0, 22.0 ],
					"style" : "",
					"text" : "sc.avg.window @window_size 256",
					"varname" : "sc.avg.window[3]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 660.0, 242.0, 189.0, 22.0 ],
					"style" : "",
					"text" : "sc.avg.window @window_size 64",
					"varname" : "sc.avg.window[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 660.0, 214.0, 189.0, 22.0 ],
					"style" : "",
					"text" : "sc.avg.window @window_size 16",
					"varname" : "sc.avg.window[1]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 660.0, 185.0, 182.0, 22.0 ],
					"style" : "",
					"text" : "sc.avg.window @window_size 4",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 104.0, 150.0, 60.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 32.0, 214.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 32.0, 249.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "qmetro 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 32.0, 277.0, 94.0, 22.0 ],
					"style" : "",
					"text" : "drunk 8000 100"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 203.0, 380.0, 431.0, 252.0 ],
					"setminmax" : [ 0.0, 1.0 ],
					"setstyle" : 3,
					"size" : 5,
					"style" : ""
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 309.0, 329.5, 150.0, 33.0 ],
					"style" : "",
					"text" : "Make everything normalized"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 335.0, 100.0, 22.0 ],
					"style" : "",
					"text" : "vexpr $f1 / 8000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 203.0, 308.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "join 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 245.0, 277.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 245.0, 244.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 245.0, 206.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 245.0, 168.0, 153.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 76.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "r light_in"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 260.0, 31.0, 475.0, 33.0 ],
					"style" : "",
					"text" : "Types of Smoothing By Averaging",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 159.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "s light_in"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 20.0, 106.0, 22.0 ],
					"style" : "",
...
,
					"patching_rect" : [ 20.0, 49.0, 88.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 81.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "spray 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 20.0, 115.5, 70.0, 29.0 ],
					"style" : ""
				}
...
, 			{
				"name" : "sc.util.downsample.maxpat",
				"bootpath" : "~/Documents/Max 7/Packages/SC/patchers/utilities",
				"patcherrelativepath" : "../../../SC/patchers/utilities",
				"type" : "JSON",
				"implicit" : 1
